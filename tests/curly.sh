...
reviewData='{"bizId": 1, "uId": 1, "stars": 5, "cost": 3, "text": "test review"}'
photoData='{"pId": 1, "bizId": 1, "uId": 1, "caption": "test caption", "imageUrl": "https://www.pinkyprintsco.com/cdn/shop/products/image_b5fa652d-a4dd-49b7-bea0-70b41a0e02fc_530x@2x.jpg?v=1665181738"}'

curl -X POST -H "Content-Type: application/json" -d '{"userId": 0, "name": "test user"}' -4 "127.0.0.1:8000/users"
# post business
